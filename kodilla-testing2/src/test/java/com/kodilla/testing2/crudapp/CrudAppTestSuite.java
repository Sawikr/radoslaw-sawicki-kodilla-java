...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://sawikr.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("sawikr10@gmail.com");
        WebElement el = driverTrello.findElement(By.id("login"));
        el.click();

        Thread.sleep(4000);

        driverTrello.findElement(By.id("password")).sendKeys("PasswordTest!");//enter the correct password
